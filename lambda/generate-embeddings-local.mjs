#!/usr/bin/env node
/**
 * Generates vector embeddings for use_cases.json locally using OpenAI
 ...
 *
 * Usage:
 *   OPENAI_API_KEY=sk-... node lambda/generate-embeddings-local.mjs
 *
 * Output:
...
const OUTPUT = resolve(__dir, "../public/data/pure_use_cases_embeddings.json");

const MODEL      = "text-embedding-3-small";
const DIMENSIONS = 1536;

// Retry config for transient OpenAI rate-limit errors
const MAX_RETRIES    = 3;
...
async function main() {
    ...
    console.log("\nUpload to S3:");
    console.log("  aws s3 cp public/data/pure_use_cases_embeddings.json s3://YOUR_BUCKET/pure_use_cases_embeddings.json\n");
}
